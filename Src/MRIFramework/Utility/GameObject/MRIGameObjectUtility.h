...
namespace MRI::GameObjectUtility
{
	...
	void RecursiveAddComponent(const std::shared_ptr<MRI::GameObject>& a_self , const std::vector<std::shared_ptr<MRI::Component::ComponentBase>>& a_addComponentList , std::vector<MRI::CommonStruct::ChildLoad>& a_childLoadList);
