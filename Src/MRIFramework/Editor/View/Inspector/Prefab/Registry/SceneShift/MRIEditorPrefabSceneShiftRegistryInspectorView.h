...
namespace MRI::Editor
{
	...
	private:
		...
		const std::string k_fileIOPath = "Asset/Data/Setting/Editor/PrefabRegistry/SceneShift/PrefabSceneShiftRegistrySetting.json";
		...
		std::uint32_t m_addSceneShiftTag = MRI::CommonConstant::k_invalidStaticID;
	};
}