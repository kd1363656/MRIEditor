...
namespace MRI::Editor
{
	...
	private:
		...
		const std::string k_fileIOPath = "Asset/Data/Setting/Editor/PrefabRegistry/GameObject/GameObjectPrefabRegistrySetting.json";
		...
		std::string m_prefabNameBuffer = std::string(MRI::CommonConstant::k_stringUnknown);
	};
}