#include "MRIFPSController.h"

void MRI::FPSController::Init()
{
	// 初期化時に過去の時間を計測
...
// FPS制御
void MRI::FPSController::Control() const
{
	// 現在の時刻を取得
...
// 現在のFPS計測
void MRI::FPSController::Monitoring()
{
	if (m_deltaTime > 0.0f)
	{
